            ...
            <article class="dokan-product-listing-area">
                ...
                <div class="product-listing-top dokan-clearfix">
                    ...
                    <?php if ( dokan_is_seller_enabled( get_current_user_id() ) ): ?>
                        <span class="dokan-add-product-link">
                            <a href="<?php echo admin_url('/post-new.php?post_type=product'); //dokan_get_navigation_url( 'new-product' ); ?>" class="dokan-btn dokan-btn-theme dokan-right <?php echo ( 'on' == dokan_get_option( 'disable_product_popup', 'dokan_selling', 'off' ) ) ? '' : 'dokan-add-new-product'; ?>">
                ...
                <div class="dokan-dahsboard-product-listing-wrapper">
                    <table class="dokan-table dokan-table-striped product-listing-table">
                        <thead>
                            <tr>
                                <th colspan="2"><?php _e( 'Name', 'dokan-lite' ); ?></th>
                                ...
                                while ($product_query->have_posts()) {
                                    ...
                                    <td data-title="<?php _e( 'Name', 'dokan-lite' ); ?>">
                                        ...
                                        <div class="row-actions">
                                            <span class="edit"><a href="<?php echo admin_url('/post.php?post='. $post->ID .'&action=edit'); //dokan_edit_product_url( $post->ID ); ?>"><?php _e( 'Edit', 'dokan-lite' ); ?></a> | </span>
