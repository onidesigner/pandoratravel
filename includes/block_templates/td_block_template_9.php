...
class td_block_template_9 extends td_block_template {
    ...
    function get_pull_down_filter() {
        ...
        foreach ($td_pull_down_items as $item) {
            if(($item['id'] == 'featured')) $active_class = 'td-cur-simple-item';
            else $active_class = '';
            $buffy .= '<li class="td-subcat-item"><a class="td-subcat-link '. $active_class .'" id="' . td_global::td_generate_unique_id() . '" data-td_filter_value="' . $item['id'] . '" data-td_block_id="' . $this->get_block_uid() . '" href="#">' . $item['name'] . '</a></li>';
        }
        $buffy .= '</ul>';
