...
<div class="td-header-sp-top-menu">
    ...
    if (td_util::get_option('tds_login_sign_in_widget') == 'show') {
        ...
        if ( is_user_logged_in() ) {
            ...
            echo '<ul class="top-header-menu td_ul_login"><li class="menu-item"><a class="menu-item" href="'. $user_url .'">' . __td('Sign in / Join', TD_THEME_NAME) . '</a><span class="td-sp-ico-login td_sp_login_ico_style"></span></li></ul>';
        }
    }//end login window
