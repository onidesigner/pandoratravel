...
if ($users_can_register == 1) {
	...
	$users_can_register_tab = ' <span></span><a href="'. $user_url .'#register">' . __td('Join', TD_THEME_NAME) . '</a>';
}
...
echo '
    <div class="td-guest-wrap">
        ...
        <div class="td-menu-login"><a href="'. $user_url .'#login">' . __td('Sign in', TD_THEME_NAME) . '</a>' . $users_can_register_tab . '</div>
    </div>
';