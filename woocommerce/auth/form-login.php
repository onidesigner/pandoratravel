...
<form method="post" class="wc-auth-login">
	<p class="form-row form-row-wide">
		<input type="text" class="input-text" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" placeholder="<?php _e( 'Username or email address', 'woocommerce' ); ?>"/>
	</p>
	<p class="form-row form-row-wide">
